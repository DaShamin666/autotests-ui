...
class CreateCourseFormComponent(BaseComponent):
    ...
    @allure.step('Fill create course form with title "{title}"')  # Добавили allure шаг
    ...
    @allure.step('Check visible create course form with title "{title}"')  # Добавили allure шаг
