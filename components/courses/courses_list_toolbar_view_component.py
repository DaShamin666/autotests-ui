...
class CoursesListToolbarViewComponent(BaseComponent):
    ...
    @allure.step("Check visible courses list toolbar")  # Добавили allure шаг
    ...
    @allure.step("Click create course button and navigate to create course page")  # Добавили allure шаг
